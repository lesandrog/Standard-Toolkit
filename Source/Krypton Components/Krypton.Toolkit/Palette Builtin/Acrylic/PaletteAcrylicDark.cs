...
/// <summary>
/// Acrylic Dark palette variant inspired by Windows 10 Fluent Design System.
/// Features semi-transparent dark surfaces with subtle blur effects and modern color schemes.
/// </summary>
public class PaletteAcrylicDark : PaletteAcrylicBase
{
    ...
    static PaletteAcrylicDark()
    {
        ...
        // Build glyph palette dynamically from the Acrylic Dark scheme
        var scheme = new PaletteAcrylicDark_BaseScheme();
    ...
    public PaletteAcrylicDark()
        : base(new PaletteAcrylicDark_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
    }
