...
/// <summary>
/// Mica Light palette variant inspired by Windows 11 Fluent Design System.
/// Features subtle translucency effects with better performance than Acrylic.
/// </summary>
public class PaletteMicaLight : PaletteMicaBase
{
    ...
    static PaletteMicaLight()
    {
        ...
        // Build glyph palette dynamically from the Mica Light scheme
        var scheme = new PaletteMicaLight_BaseScheme();
    ...
    public PaletteMicaLight()
        : base(new PaletteMicaLight_BaseScheme(), _checkBoxList, _galleryButtonList, _radioButtonArray)
    {
    }
