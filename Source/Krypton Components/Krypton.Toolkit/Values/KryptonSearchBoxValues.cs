...
internal class KryptonSearchBoxValues : Storage
{
    ...
    private InternalKryptonSearchBox? _owner;
    #endregion
    ...
    public KryptonSearchBoxValues(InternalKryptonSearchBox? owner)
    {
        _owner = owner;
        // Button defaults
    ...
    internal void SetOwner(InternalKryptonSearchBox owner) => _owner = owner;
