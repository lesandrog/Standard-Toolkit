...
using SearchBoxImageResources = Krypton.Toolkit.ResourceFiles.SearchBox.SearchBoxImageResources;
...
internal partial class InternalKryptonSearchBox : KryptonTextBox
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InternalKryptonSearchBox"/> class.
    /// </summary>
    public InternalKryptonSearchBox()
    {
